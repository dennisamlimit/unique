...
const THEME_PRESETS = [
  {
    name: "Ocean",
    theme: { primary: "#38BDF8", secondary: "#0EA5E9", border: "#7DD3FC", surface: "#07131D", surfaceAlt: "#0C1B28" }
  },
  {
    name: "Ember",
    theme: { primary: "#F97316", secondary: "#EA580C", border: "#FDBA74", surface: "#160B07", surfaceAlt: "#25130C" }
  },
  {
    name: "Neon",
    theme: { primary: "#22C55E", secondary: "#14B8A6", border: "#6EE7B7", surface: "#07140D", surfaceAlt: "#0B1E16" }
  },
  {
    name: "Royal",
    theme: { primary: "#8B5CF6", secondary: "#6366F1", border: "#C4B5FD", surface: "#0D0A18", surfaceAlt: "#17122A" }
  }
];
...
function StatCard({ icon, label, value }) {
  return (
    <div className="theme-tile flex items-center gap-3 rounded-md px-3 py-2.5 transition-colors hover:border-violet-200/[0.24] hover:bg-white/[0.05]">
      <div className="flex h-7 w-7 shrink-0 items-center justify-center rounded bg-fuchsia-500/[0.18] text-fuchsia-100">
        {icon}
      </div>
  ...
  return (
    <button
      ...
      className={`theme-nav-tile relative flex cursor-pointer items-center gap-2 rounded-md px-4 py-3 text-[11px] font-black uppercase tracking-wider transition-colors focus-visible:outline-none ${
        active ? "border-fuchsia-400 bg-fuchsia-500/[0.12] text-white theme-primary-glow" : "text-zinc-500 hover:border-violet-300/[0.25] hover:text-zinc-300"
      }`}
    >
      {children}
    </button>
  ...
  return (
    <div className="relative isolate" data-prefix-combobox>
      ...
      >
        ...
        <span className={`shrink-0 text-fuchsia-200 transition ${open ? "rotate-180" : ""}`}>
          <ChevronDownIcon />
        </span>
      </button>
      <PortalPopover
            ...
            return (
              <button
                ...
                className={`theme-nav-tile rounded-md px-3 py-2 text-left text-[11px] font-black uppercase transition ${
                  active
                    ? "border-fuchsia-300/[0.4] bg-fuchsia-500/[0.14] text-white"
      ...
      <div className="theme-tile theme-tile-hero relative flex flex-col items-center overflow-hidden rounded-md pb-4 pt-6">
        ...
        <div className="relative z-10 flex w-full flex-col items-center gap-3 px-4">
          <div className="relative">
            <div className="theme-primary-glow flex h-28 w-28 items-center justify-center overflow-hidden rounded-full border-2 border-fuchsia-400/35 bg-zinc-900">
              <svg className="h-18 w-18 text-zinc-700" fill="currentColor" viewBox="0 0 24 24">
                <path d="M12 12c2.7 0 4.8-2.1 4.8-4.8S14.7 2.4 12 2.4 7.2 4.5 7.2 7.2 9.3 12 12 12zm0 2.4c-3.2 0-9.6 1.6-9.6 4.8v2.4h19.2v-2.4c0-3.2-6.4-4.8-9.6-4.8z"/>
              </svg>
            </div>
            <div className="absolute -bottom-1 -right-1 rounded-full border border-black/60 bg-fuchsia-500 px-2 py-0.5 text-[9px] font-black text-white">
              ID {p.accountId || "?"}
            </div>
          </div>
          ...
          <div className="text-center">
            ...
            {p.factionName ? (
              <div className="mt-1 text-[10px] font-bold uppercase text-fuchsia-300">
            ...
            {p.adminLevel > 0 && (
              <div className="rounded border border-fuchsia-400/30 bg-fuchsia-500/10 px-2 py-0.5 text-[9px] font-black uppercase text-fuchsia-200">
        ...
        <div className="theme-tile grid gap-4 rounded-md p-5">
          ...
          <div className="mt-4 grid gap-3">
            ...
            <button
              ...
              className="h-10 cursor-pointer rounded-md bg-fuchsia-500 text-[10px] font-black uppercase text-white transition-colors hover:bg-fuchsia-400"
            >
              Ticket absenden
            </button>
            {ticketCreateNotice && (
      ...
      <div className="theme-panel theme-tile rounded-md p-5">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <div className="mt-1 text-sm font-semibold text-zinc-400">Ein Theme für HUD, M-Menü und Admin-Menü. Erst beim Speichern wird alles übernommen.</div>
          </div>
        </div>
...
function UsermenuApp() {
  ...
  useEffect(() => {
    window.usermenuApp = {
      ...
      setTheme: (rawPayload) => {
        const parsed = typeof rawPayload === "string" ? (parsePayload(rawPayload) || getStoredUiTheme()) : (rawPayload || getStoredUiTheme());
        setTheme(persistUiTheme(normalizeUiTheme(parsed)));
      }
    };
        ...
        <header className="flex items-center justify-between border-b border-violet-200/[0.12] px-8 py-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="font-display text-lg leading-none text-white">PLAYER MENU</div>
            </div>
          </div>
          <div className="flex items-center gap-3">
