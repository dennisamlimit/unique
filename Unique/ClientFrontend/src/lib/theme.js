...
export function getStoredUiTheme() {
  // We no longer rely on localStorage across browsers.
  // The client script is the source of truth and pushes the theme.
  return DEFAULT_UI_THEME;
}

export function persistUiTheme(theme) {
  return normalizeUiTheme(theme);
}
...
.unique-theme .theme-chat-primary-border {
  border-color: rgb(var(--ui-chat-rgb) / 0.35) !important;
}

.unique-theme .theme-chat-primary-bg {
  background-color: var(--ui-chat) !important;
}
