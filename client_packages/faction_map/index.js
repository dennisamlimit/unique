(() => {
  // client_src/faction_map/index.ts
  var blips = /* @__PURE__ */ new Map();
  var BLIP_COLOR_PALETTE = [
  ...
  function mapHexToBlipColor(hex) {
  ...
  function clearBlips() {
    ...
    for (const blip of blips.values()) {
      (_a = blip.destroy) == null ? void 0 : _a.call(blip);
    }
    blips.clear();
  }
  function setData(rawPayload) {
    var _a, _b, _c, _d;
    clearBlips();
    let points = [];
    try {
    ...
    for (const point of points) {
      const blip = (_b = (_a = mp.blips) == null ? void 0 : _a.new) == null ? void 0 : _b.call(_a, Number(point.mapIconId || 1), new mp.Vector3(point.x, point.y, point.z), {
      ...
      (_c = blip.setColour) == null ? void 0 : _c.call(blip, color);
      (_d = blip.setColor) == null ? void 0 : _d.call(blip, color);
      blip.color = color;
  ...
  mp.events.add("client:factionMap:setData", (...args) => {
    const [payload] = args;
    setData(payload || "[]");
  });
